...
{'kb_search': {'argument': 'query',  # noqa: E122
 ...
 'ask_user': {'call': {'en': 'Gathering questions for you, please wait…',
              ...
              'success': {'en': 'Please answer the questions below.',
                          'zh': '请您回答下面的问题'}},
 'MailToolkit_search': {'argument': 'mailbox / folder / after / keyword',
                        'call': {'en': 'Searching mail: {value}.',
                                 'zh': '正在搜索邮件：{value}。'},
                        'success': {'en': 'Found {count} emails.',
                                    'zh': '找到 {count} 封邮件。'},
                        'failure': {'en': 'Mail search failed.',
                                    'zh': '邮件搜索失败。'}},
 'MailToolkit_read': {'argument': 'message_id',
                      'call': {'en': 'Reading email {value}.',
                               'zh': '正在读取邮件 {value}。'},
                      'success': {'en': 'Email {value} was loaded.',
                                  'zh': '已读取邮件 {value}。'},
                      'failure': {'en': 'Email {value} could not be loaded.',
                                  'zh': '未能读取邮件 {value}。'}},
 'MailToolkit_read_thread': {'argument': 'thread_id',
                             'call': {'en': 'Reading email thread {value}.',
                                      'zh': '正在读取邮件会话 {value}。'},
                             'success': {'en': 'Email thread {value} was loaded.',
                                         'zh': '已读取邮件会话 {value}。'},
                             'failure': {'en': 'Email thread {value} could not be loaded.',
                                         'zh': '未能读取邮件会话 {value}。'}},
 'MailToolkit_read_attachment': {'argument': 'attachment_id',
                                 'call': {'en': 'Reading email attachment {value}.',
                                          'zh': '正在读取邮件附件 {value}。'},
                                 'success': {'en': 'Email attachment {value} was loaded.',
                                             'zh': '已读取邮件附件 {value}。'},
                                 'failure': {'en': 'Email attachment {value} could not be loaded.',
                                             'zh': '未能读取邮件附件 {value}。'}},
 'MailToolkit_compose_draft': {'argument': 'subject',
                               'call': {'en': 'Preparing an email draft: {value}.',
                                        'zh': '正在生成邮件草稿：{value}。'},
                               'success': {'en': 'Email draft is ready for confirmation.',
                                           'zh': '邮件草稿已生成，等待确认发送。'},
 ...
 'MailToolkit_send_draft': {'argument': 'draft_id',
                            ...
                            'success': {'en': 'Email sent at {result.sent_at}.',
                                        'zh': '邮件已于 {result.sent_at} 发送成功。'},
                            'failure': {'en': 'Email send failed. The draft was kept.',
                                        'zh': '邮件发送失败，草稿和附件已保留。'}},
