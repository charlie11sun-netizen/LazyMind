...
func TestRepositoryStructuredMigrationCatalogLoads(t *testing.T) {
	...
	if !containsMigrationFileVersion(v03.Dev, 20260910050131) {
		t.Fatal("v0_3 dev migrations are missing conversation groups")
	}
