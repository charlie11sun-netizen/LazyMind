...
func TableNamesForDDL() []string {
	return []string{
		...
		"mcp_servers",
		"agent_invocations",
		"external_capability_invocations",
		"external_capability_grants",
		"multi_answers_switches",
		"conversations",
		"external_agent_bindings",
		"conversation_archive_folders",
		"conversation_groups",
		"conversation_group_members",
		"conversation_group_states",
		"conversation_organizer_runs",
		"conversation_organizer_snapshot_items",
		"conversation_organizer_changes",
		"external_chat_run_events",
		"external_chat_hosts",
		"external_agent_runs",
		"chat_histories",
		"multi_answers_chat_histories",
		"chat_run_performance",
		"sub_agent_tasks",
		"sub_agent_steps",
		"sub_agent_artifacts",
		...
		"user_selected_cloud_models",
		"user_selected_providers",
		"documents",
		"document_processing_states",
		"academic_works",
		"academic_work_documents",
		"academic_references",
