...
lint-test-locations:
	@python3 scripts/check_test_locations.py

lint: lint-python lint-go lint-state-backend-boundary lint-workflow-naming lint-migration-immutability lint-test-locations
