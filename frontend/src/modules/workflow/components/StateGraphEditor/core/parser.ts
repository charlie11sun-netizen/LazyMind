 ...
 * Note: slots are NOT parsed here — they live in workflow.yaml and are loaded separately.
 */
export function parseYaml(yamlText: string): GraphModel | null {
  ...
  // slots block is intentionally omitted — slot definitions live in workflow.yaml, not state.yml.
  ...
  // steps can be either an array (AI-generated drafts) or a dict (hand-authored workflows).
